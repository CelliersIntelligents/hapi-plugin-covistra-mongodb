var Fixtures = require('./fixtures-loader'),
...
module.exports = function(server, log, config, dbs, options) {
    ...
    return P.map(dbs, function(dbSpec) {
        ...
        if(dbSpec.fixturePath) {
            ...
            return Fixtures.load(dbSpec).then(function(loader) {
                return loader.loadFixtures(dbSpec.fixturePath, { clear: dbSpec.clear || true });
            });
